...
export default function LoginPage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 md:p-10 transition-all duration-300">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 border ${errors.username ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200 ${errors.username ? 'ring-red-200 dark:ring-red-800' : ''}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-12 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition-all duration-200 ${errors.password ? 'ring-red-200 dark:ring-red-800' : ''}`}
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 rounded-lg border border-blue-100 dark:border-gray-600">
