...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/projects/newPTS/assets/css/styles.css">
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-slate-800 text-white flex flex-col shadow-xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="/projects/newPTS/pages/dashboard.php" 
                ...
                <a href="/projects/newPTS/pages/projects.php" 
                ...
                <a href="/projects/newPTS/pages/project-form.php" 
                ...
                <a href="/projects/newPTS/pages/import.php" 
                ...
                <a href="/projects/newPTS/pages/reports.php" 
                ...
                <a href="/projects/newPTS/pages/advanced-reports.php" 
                ...
                <?php if (isAdmin()): ?>
                <a href="/projects/newPTS/pages/admin.php" 
            ...
            <div class="p-4 border-t border-slate-700">
                <a href="/projects/newPTS/pages/profile.php" class="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="/projects/newPTS/index.php" class="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="/projects/newPTS/logout.php" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
