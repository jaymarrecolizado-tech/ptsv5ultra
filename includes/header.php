    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-slate-800 text-white flex flex-col shadow-xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <a href="../pages/import-typed.php" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo $activeTab === 'import-typed' ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'; ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    <span>Import by Type</span>
                </a>
...
<a href="../pages/reports.php" 
                ...
                <a href="../pages/reports-typed.php" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors <?php echo $activeTab === 'reports-typed' ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'; ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
